...
const Signup = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (!formData.nameOrMobile || !formData.email || !formData.password) {
    ...
    // Check if the input is a mobile number (digits only)
    const isMobile = /^\d+$/.test(formData.nameOrMobile);
    
    // Validate mobile number format if it appears to be a mobile number
    ...
    localStorage.setItem("user", JSON.stringify({
      ...formData,
      // Store whether the input was a mobile number for later reference
      isMobile: isMobile
    }));
    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-100">
      ...
      <div className="bg-white shadow-xl rounded-xl w-full max-w-md p-8 transform hover:scale-105 transition duration-300">
        ...
        <div className="text-center mb-6">
          <h1 className="text-4xl font-bold text-blue-600 mb-2">Laundry<span className="text-gray-800">Hub</span></h1>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          <input
            type="text"
            name="nameOrMobile"
            placeholder="Full Name or Mobile Number *"
        ...
        <div className="flex justify-center space-x-4">
          ...
          >
            ...
            <svg className="w-6 h-6" viewBox="0 0 24 24" fill="#1DA1F2">
              <path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.919 13.919 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z" />
            </svg>
          </button>
