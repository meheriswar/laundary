...
const ServiceSelection = () => {
  ...
  const handleNext = () => {
    ...
    navigate(`/order-details?services=${serviceString}`);
  };
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {services.map((service) => (
            <div
              key={service.id}
              className={`relative bg-white rounded-xl shadow-lg p-8 transform transition-transform duration-300 hover:scale-105 ${
            ...
            >
              ...
              <div className="absolute top-4 right-4">
                <input
                  ...
                  className="h-6 w-6 text-blue-600 rounded-full border-gray-300 focus:ring-blue-500 cursor-pointer"
                />
              </div>
            </div>
          ))}
        ...
        <div className="mt-12 text-center">
          <button
            onClick={handleNext}
            className="px-8 py-4 bg-blue-600 text-white font-bold text-lg rounded-lg shadow-lg hover:bg-blue-700 transition-colors duration-300 focus:outline-none focus:ring-4 focus:ring-blue-500 focus:ring-opacity-50"
          >
            Continue
          </button>
        </div>
